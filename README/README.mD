...
<html lang="en">
  ...
  <meta property="fb:app_id" content="1401488693436528">
    ...
    <meta property="og:image" content="https://avatars2.githubusercontent.com/u/38454592?s=400&amp;v=4" /><meta property="og:site_name" content="GitHub" /><meta property="og:type" content="object" /><meta property="og:title" content="Gift-Lumumba/my-first-web-page-2" /><meta property="og:url" content="https://github.com/Gift-Lumumba/my-first-web-page-2" /><meta property="og:description" content="Contribute to my-first-web-page-2 development by creating an account on GitHub." />

  <link rel="assets" href="https://assets-cdn.github.com/">
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MjY3Mjc4OTc3OmE3ZmEzMzY0ZjIyYzM4OWZiMzI3NTVmMjVlNGY4NmEyNTZjZWFkZjAwNWE5NjM4YmZiN2EzYmZlM2E0Mzc4OTk=--f1489dced338d2145cbf6d25433bc9eb45f2d201">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="9214:4405:2781828:4886CB4:5AD840F8" data-pjax-transient>
...
<meta name="octolytics-host" content="collector.githubapp.com" /><meta name="octolytics-app-id" content="github" /><meta name="octolytics-event-url" content="https://collector.githubapp.com/github-external/browser_event" /><meta name="octolytics-dimension-request_id" content="9214:4405:2781828:4886CB4:5AD840F8" /><meta name="octolytics-dimension-region_edge" content="iad" /><meta name="octolytics-dimension-region_render" content="iad" /><meta name="octolytics-actor-id" content="38454592" /><meta name="octolytics-actor-login" content="Gift-Lumumba" /><meta name="octolytics-actor-hash" content="af5eab21afda21f1a10348c778f371b11106526cdc424a5ea6e4890db6af136c" />
<meta name="analytics-location" content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/new" data-pjax-transient="true" />
  ...
  <meta class="js-ga-set" name="dimension1" content="Logged In">
    ...
    <meta name="user-login" content="Gift-Lumumba">

      <meta name="expected-hostname" content="github.com">
    <meta name="js-proxy-site-detection-payload" content="">
  ...
  <meta name="html-safe-nonce" content="8dc39c7336c469e515e6b14bf29404bed0b15d4c">

  <meta http-equiv="x-pjax-version" content="64f03629d5075031842780cedb552ba9">
  

      <link href="https://github.com/Gift-Lumumba/my-first-web-page-2/commits/master.atom" rel="alternate" title="Recent Commits to my-first-web-page-2:master" type="application/atom+xml">

  <meta name="description" content="Contribute to my-first-web-page-2 development by creating an account on GitHub.">
  <meta name="go-import" content="github.com/Gift-Lumumba/my-first-web-page-2 git https://github.com/Gift-Lumumba/my-first-web-page-2.git">

  <meta name="octolytics-dimension-user_id" content="38454592" /><meta name="octolytics-dimension-user_login" content="Gift-Lumumba" /><meta name="octolytics-dimension-repository_id" content="130069735" /><meta name="octolytics-dimension-repository_nwo" content="Gift-Lumumba/my-first-web-page-2" /><meta name="octolytics-dimension-repository_public" content="true" /><meta name="octolytics-dimension-repository_is_fork" content="false" /><meta name="octolytics-dimension-repository_network_root_id" content="130069735" /><meta name="octolytics-dimension-repository_network_root_nwo" content="Gift-Lumumba/my-first-web-page-2" /><meta name="octolytics-dimension-repository_explore_github_marketplace_ci_cta_shown" content="true" />
...
<header class="Header  f5" role="banner">
  ...
  <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scoped-search-url="/Gift-Lumumba/my-first-web-page-2/search" data-unscoped-search-url="/search" action="/Gift-Lumumba/my-first-web-page-2/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
    <label class="form-control header-search-wrapper  js-chromeless-input-container">
          <a class="header-search-scope no-underline" href="/Gift-Lumumba/my-first-web-page-2/new/master">This repository</a>
      <input type="text"
...
<ul class="user-nav d-flex flex-items-center list-style-none" id="user-links">
  <li class="dropdown js-menu-container">
    ...
    <a aria-label="You have no unread notifications" class="notification-indicator tooltipped tooltipped-s  js-socket-channel js-notification-indicator" data-hotkey="g n" data-ga-click="Header, go to notifications, icon:read" data-channel="notification-changed:38454592" href="/notifications">
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <div class="dropdown-header">
    <span title="Gift-Lumumba/my-first-web-page-2">This repository</span>
  </div>
    <a class="dropdown-item" href="/Gift-Lumumba/my-first-web-page-2/issues/new" data-ga-click="Header, create new issue">
      New issue
    </a>
  ...
  <li class="dropdown js-menu-container">
    ...
    <details class="dropdown-details details-reset js-dropdown-details d-flex pl-2 flex-items-center">
      <summary class="HeaderNavlink name mt-1"
        ...
        <img alt="@Gift-Lumumba" class="avatar float-left mr-1" src="https://avatars2.githubusercontent.com/u/38454592?s=40&amp;v=4" height="20" width="20">
        <span class="dropdown-caret"></span>
      </summary>

      <ul class="dropdown-menu dropdown-menu-sw">
        <li class="dropdown-header header-nav-current-user css-truncate">
          Signed in as <strong class="css-truncate-target">Gift-Lumumba</strong>
        </li>

        <li class="dropdown-divider"></li>

        <li><a class="dropdown-item" href="/Gift-Lumumba" data-ga-click="Header, go to profile, text:your profile">
          Your profile
        </a></li>
        <li><a class="dropdown-item" href="/Gift-Lumumba?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">
          Your stars
        </a></li>
        ...
        <li><!-- '"` --><!-- </textarea></xmp> --></option></form><form class="logout-form" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="2e7JhTlWovAwI2Gzkpke96VTQpNk1TLagQjAcm+118MMM3AMSBF9iPb0XdxqO+iYI1M6MO6zTUqNZ1xJ59USTw==" />
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="sr-only right-0" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="obIdMKfUVj+LcWaDh+ZtCbAeeLhRyDDz/iM9crS98Th0b6S51pOJR02mWux/RJtmNh4AG9uuT2PyTKFJPN00tA==" />
          <button type="submit" class="dropdown-item dropdown-signout" data-ga-click="Header, sign out, icon:logout">
            Sign out
          </button>
</form>      </div>
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form data-autosubmit="true" data-remote="true" class="js-social-container" action="/notifications/subscribe" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="OWjxr+V5bHYQrP5KJskF5zHvP5PJRkxtFqLZd8vwN/J0CM+YY2lLyFPxpczzbPY6tU8t2HAq0Qh7XigSgES6Mw==" />      <input type="hidden" name="repository_id" id="repository_id" value="130069735" class="form-control" />

        <div class="select-menu js-menu-container js-select-menu">
          <a href="/Gift-Lumumba/my-first-web-page-2/subscription"
          ...
          <a class="social-count js-social-count"
            href="/Gift-Lumumba/my-first-web-page-2/watchers"
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="starred js-social-form" action="/Gift-Lumumba/my-first-web-page-2/unstar" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="nLmESlrVGNcp77Ims3yIxlTO+Fpf5C4XRlzCrWTdNrsege1+hNPe7Q/lTn1jb9QTUhkzw/9DNoIw11QLJQC64Q==" />
      <input type="hidden" name="context" value="repository"></input>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
        aria-label="Unstar this repository" title="Unstar Gift-Lumumba/my-first-web-page-2"
        data-ga-click="Repository, click unstar button, action:blob#new; text:Unstar">
        <svg class="octicon octicon-star" viewBox="0 0 14 16" version="1.1" width="14" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M14 6l-4.9-.64L7 1 4.9 5.36 0 6l3.6 3.26L2.67 14 7 11.67 11.33 14l-.93-4.74z"/></svg>
        Unstar
      </button>
        <a class="social-count js-social-count" href="/Gift-Lumumba/my-first-web-page-2/stargazers"
           aria-label="0 users starred this repository">
          0
        </a>
</form>
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="unstarred js-social-form" action="/Gift-Lumumba/my-first-web-page-2/star" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="YGxuK/2xGEI6sUe/51mB5toOeUEMtLnSAoVV/l8+x/LMLtbz8TKJBuLncQu3iylL5E1a80ecpoVu/+YNLyDX2w==" />
      <input type="hidden" name="context" value="repository"></input>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
        aria-label="Star this repository" title="Star Gift-Lumumba/my-first-web-page-2"
  ...
  <li>
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="btn-with-count" action="/Gift-Lumumba/my-first-web-page-2/fork" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="j25pXpoFsvfeZ/7agJ7XKgwCjOZrcD+ArWIoTWT3ysl6MrspINpTmsCxbeTpUUOMd5RQ4vu3cT8MXFhqm2WbTQ==" />
            <button
                type="submit"
                class="btn btn-sm btn-with-count"
                data-ga-click="Repository, show fork modal, action:blob#new; text:Fork"
                title="Fork your own copy of Gift-Lumumba/my-first-web-page-2 to your account"
                aria-label="Fork your own copy of Gift-Lumumba/my-first-web-page-2 to your account">
              <svg class="octicon octicon-repo-forked" viewBox="0 0 10 16" version="1.1" width="10" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M8 1a1.993 1.993 0 0 0-1 3.72V6L5 8 3 6V4.72A1.993 1.993 0 0 0 2 1a1.993 1.993 0 0 0-1 3.72V6.5l3 3v1.78A1.993 1.993 0 0 0 5 15a1.993 1.993 0 0 0 1-3.72V9.5l3-3V4.72A1.993 1.993 0 0 0 8 1zM2 4.2C1.34 4.2.8 3.65.8 3c0-.65.55-1.2 1.2-1.2.65 0 1.2.55 1.2 1.2 0 .65-.55 1.2-1.2 1.2zm3 10c-.66 0-1.2-.55-1.2-1.2 0-.65.55-1.2 1.2-1.2.65 0 1.2.55 1.2 1.2 0 .65-.55 1.2-1.2 1.2zm3-10c-.66 0-1.2-.55-1.2-1.2 0-.65.55-1.2 1.2-1.2.65 0 1.2.55 1.2 1.2 0 .65-.55 1.2-1.2 1.2z"/></svg>
              Fork
            </button>
</form>
    <a href="/Gift-Lumumba/my-first-web-page-2/network" class="social-count"
  ...
  <span class="author" itemprop="author"><a class="url fn" rel="author" href="/Gift-Lumumba">Gift-Lumumba</a></span><!--
--><span class="path-divider">/</span><!--
--><strong itemprop="name"><a data-pjax="#js-repo-pjax-container" href="/Gift-Lumumba/my-first-web-page-2">my-first-web-page-2</a></strong>
...
<nav class="reponav js-repo-nav js-sidenav-container-pjax container"
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    <a class="js-selected-navigation-item selected reponav-item" itemprop="url" data-hotkey="g c" data-selected-links="repo_source repo_downloads repo_commits repo_releases repo_tags repo_branches repo_packages /Gift-Lumumba/my-first-web-page-2" href="/Gift-Lumumba/my-first-web-page-2">
    ...
    <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
      <a itemprop="url" data-hotkey="g i" class="js-selected-navigation-item reponav-item" data-selected-links="repo_issues repo_labels repo_milestones /Gift-Lumumba/my-first-web-page-2/issues" href="/Gift-Lumumba/my-first-web-page-2/issues">
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    <a data-hotkey="g p" itemprop="url" class="js-selected-navigation-item reponav-item" data-selected-links="repo_pulls checks /Gift-Lumumba/my-first-web-page-2/pulls" href="/Gift-Lumumba/my-first-web-page-2/pulls">
    ...
    <a data-hotkey="g b" class="js-selected-navigation-item reponav-item" data-selected-links="repo_projects new_repo_project repo_project /Gift-Lumumba/my-first-web-page-2/projects" href="/Gift-Lumumba/my-first-web-page-2/projects">
      <svg class="octicon octicon-project" viewBox="0 0 15 16" version="1.1" width="15" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M10 12h3V2h-3v10zm-4-2h3V2H6v8zm-4 4h3V2H2v12zm-1 1h13V1H1v14zM14 0H1a1 1 0 0 0-1 1v14a1 1 0 0 0 1 1h13a1 1 0 0 0 1-1V1a1 1 0 0 0-1-1z"/></svg>
      Projects
      <span class="Counter" >0</span>
</a>
    <a class="js-selected-navigation-item reponav-item" data-hotkey="g w" data-selected-links="repo_wiki /Gift-Lumumba/my-first-web-page-2/wiki" href="/Gift-Lumumba/my-first-web-page-2/wiki">
      <svg class="octicon octicon-book" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M3 5h4v1H3V5zm0 3h4V7H3v1zm0 2h4V9H3v1zm11-5h-4v1h4V5zm0 2h-4v1h4V7zm0 2h-4v1h4V9zm2-6v9c0 .55-.45 1-1 1H9.5l-1 1-1-1H2c-.55 0-1-.45-1-1V3c0-.55.45-1 1-1h5.5l1 1 1-1H15c.55 0 1 .45 1 1zm-8 .5L7.5 3H2v9h6V3.5zm7-.5H9.5l-.5.5V12h6V3z"/></svg>
      Wiki
</a>

  <a class="js-selected-navigation-item reponav-item" data-selected-links="repo_graphs repo_contributors dependency_graph pulse /Gift-Lumumba/my-first-web-page-2/pulse" href="/Gift-Lumumba/my-first-web-page-2/pulse">
    <svg class="octicon octicon-graph" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M16 14v1H0V0h1v14h15zM5 13H3V8h2v5zm4 0H7V3h2v10zm4 0h-2V6h2v7z"/></svg>
    Insights
</a>
    <a class="js-selected-navigation-item reponav-item" data-selected-links="repo_settings repo_branch_settings hooks integration_installations repo_keys_settings /Gift-Lumumba/my-first-web-page-2/settings" href="/Gift-Lumumba/my-first-web-page-2/settings">
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  ...
  <div class="file-box">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="d-none js-blob-preview-form" action="/Gift-Lumumba/my-first-web-page-2/preview/master" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="Z6s3/bwg5GgDXPWI3MJj758WQYaZAOVP59/TxX7O1TZAnLbXfSuL65BxQio6HMNGLk/nZ6mfxNEO8ASrcutpKw==" />
...
</form>    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-blob-form" data-github-confirm-unload="Your new changes will be lost." action="/Gift-Lumumba/my-first-web-page-2/create/master" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="Drfnl5SQriVlkZEyOHBm4WnRtai5NnG2dtQ0RBN7Z82MwBwGEJvBGo5kCeIXJjSpiH4thJMmZraP7h8oEwgRaA==" />
  ...
  <div class="select-menu-modal-holder select-menu-git-ignore js-menu-content js-navigation-container">
    ...
    <div class="select-menu-modal">
      ...
      <div class="editor-license-template js-license-template js-template-suggestion d-none" data-template-suggestion-pattern="^(.+\/)?(licen[sc]e|copying)($|\.)">
          <a class="btn btn-sm" data-template-button href="/Gift-Lumumba/my-first-web-page-2/community/license/new?branch=master">Choose a license template</a>
      </div>
      <div class="editor-code-of-conduct-template js-template-suggestion d-none" data-template-suggestion-pattern="^(code.?of.?conduct|coc)($|\.)">
        <a class="btn btn-sm" data-template-button href="/Gift-Lumumba/my-first-web-page-2/community/code-of-conduct/new">Choose a code of conduct template</a>
      </div>

    <span class="js-breadcrumb-container">
      <span class="repo-root js-repo-root"><span class="js-path-segment"><a data-pjax="true" href="/Gift-Lumumba/my-first-web-page-2"><span>my-first-web-page-2</span></a></span></span><span class="separator">/</span>
    ...
    <span class="editor-abort">or <a href="/Gift-Lumumba/my-first-web-page-2">cancel</a></span>
...
<input type="hidden" name="commit" class="js-commit-oid" value="afadfb861ee957c1547e853f1ee8922d9c4eaf0c">
...
<div class="file-commit-form js-file-commit-form">
  <span class="commit-form-avatar">
    <img class="float-left rounded-1" src="https://avatars0.githubusercontent.com/u/38454592?s=96&amp;v=4" width="48" height="48" alt="@Gift-Lumumba" data-hovercard-user-id="38454592" />
  </span>
...
<div class="ml-6 js-quick-pull-branch-name mt-2 d-none">
  <div class="position-relative mt-2 ml-2">
    ...
    <input type="text" value="Gift-Lumumba-patch-1"
      ...
      data-generated-branch="Gift-Lumumba-patch-1"
      data-check-url="https://github.com/Gift-Lumumba/my-first-web-page-2/ref_check#csrf-token=oZHYv/5JXTLVNgiW/zBMQa49l+mmcgNBggYVjlR0zJxKaXhn08fQSafr5Nv5Eb8difF58Ct0AdGffS6f29Cgcw==">
...
<input type="hidden" name="quick_pull" class="js-quick-pull-choice-value" value="">
  ...
  <a class="btn btn-danger" href="/Gift-Lumumba/my-first-web-page-2">Cancel</a>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.24607s from unicorn-3429199719-nf076">GitHub</span>, Inc.</li>
  ...
  <div id="ajax-error-message" class="ajax-error-message flash flash-error">
    ...
    <script crossorigin="anonymous" async="async" type="application/javascript" src="https://assets-cdn.github.com/assets/github-aee23ce1bb818e2e56f43f679d1dcdbf.js"></script>
        ...
        <script crossorigin="anonymous" type="application/javascript" src="https://assets-cdn.github.com/assets/editor-a2c28e4c3002fa9c979325403ff905ea.js"></script>
